...
RUN ln -sf /usr/bin/python3 /usr/bin/python && python3 -m ensurepip && bash -c "python3 -m venv /etc/venv && . /etc/venv/bin/activate && pip3 install --no-cache --upgrade pip setuptools requests "

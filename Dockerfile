...
RUN apk add --update --no-cache curl bash caddy python3 nss-tools screen nano &&  curl -sL https://github.com/jpillora/chisel/releases/download/v1.11.3/chisel_1.11.3_linux_amd64.gz |gunzip > /tmp/chi && chmod +x /tmp/chi && mv /tmp/chi /usr/bin/chi
